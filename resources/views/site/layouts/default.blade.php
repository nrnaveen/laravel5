                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            <li {{ (Request::is('/') ? ' class="active"' : '') }}>
                                <a href="{{{ URL::to('') }}}">{{{ trans('site/site.home') }}}</a>
                            </li>
                        </ul>
                                ...
                                @if(isset($admin))
                                    <li>
                                        <a href="{{{ URL::to('admin/dashboard') }}}">
                                            {{{ trans('site/site.admin_panel') }}}
                                        </a>
                                    </li>
                                @endif
                                <li>
                                    <a href="#">
                                        {{{ trans('site/site.login_as') }}} 
                                        {{{ Auth::user()->name }}}
                                    </a>
                                </li>
                                <li>
        ...
        <div id="footer">
            <div class="container">
                <p class="muted credit">
                    Laravel 5 Starter Site on 
                    <a href="https://github.com/mrakodol/Laravel-5-Bootstrap-3-Starter-Site">Github</a>.
                </p>
            </div>
        </div>
        @yield('scripts')
